...
if (isset($_SESSION['login']) && $_SESSION['login'] == true) {
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $actualizar_fecha = $conexion->prepare('
			UPDATE partidos SET fecha = :fecha WHERE id = :id_partido
		');
		$actualizar_fecha->execute(array(
...
<section class="content content-center">  
	<div class="container">
		...
		<div class="container-insertar-liga">
			...
			<h2>Fecha</h2>
            <form method="post">
                <input type="text" name="fecha" value="<?php echo $partido['fecha']; ?>" required>
